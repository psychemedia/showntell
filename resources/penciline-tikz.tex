%% via: https://github.com/renard/tikz-penciline
...
%%TH: usage: load in packages ifthen,pgfplots, then load tex with \input{"resources/penciline-tikz.tex"}
